// angr-4nkj: mprotect syscall handler unit tests, extracted out of the former
// in-file `mod tests` (~224 lines) into a sibling file to shrink
// syscalls/mprotect.rs below the god-object threshold. Declared as a direct
